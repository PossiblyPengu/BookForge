...
const foliateHighlight = (block, chunkText, searchFrom = 0) => {
  ...
  // Only turn when the text has actually left the page — this runs for
  // every word, and re-anchoring each time churns relocate/saveProgress.
  try {
    if (!onPage(range)) {
